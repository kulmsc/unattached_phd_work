...
date_ass,ass_header = normRead("../get_pheno/date_assessed.csv", True, ",", True)
self_rep, self_rep_header = normRead("../get_pheno/self_report_diag.csv", True, ",", True)
big_eid, eid_head = normRead("../get_pheno/eid.csv", True, ",", True)
...
defs, head_defs = normRead("outcome_icd_codes.txt")
#pdb.set_trace()
