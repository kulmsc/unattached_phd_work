...
all_method <- unlist(lapply(split_files, function(x) x[1]))
all_chr <- unlist(lapply(split_files, function(x) x[3]))
other_method <- unlist(lapply(split_files, function(x) x[4]))
all_method[other_method != "profile"] <- paste0(all_method[other_method != "profile"], "_", other_method[other_method != "profile"])
